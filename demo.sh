...
add_plugin () {
  ...
  sudo jack_connect "a2j:Teensy MIDI [20] (playback): Teensy MIDI MIDI 1" "effect_0:$2"
  sudo jack_connect "effect_0:$3" "system:playback_1"
  sudo jack_connect "effect_0:$4" "system:playback_2"
}
